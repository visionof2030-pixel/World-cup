...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
    ...
    /* ===== Leaderboard - في أول الصفحة ===== */
    .leaderboard-section {
      background: rgba(18, 38, 44, 0.85);
    ...
    .predict-trigger-btn {
      ...
      margin-top: 12px;
      padding: 12px 16px;
      background: linear-gradient(135deg, rgba(255, 180, 70, 0.15), rgba(255, 140, 26, 0.08));
      border: 2px solid rgba(255, 180, 70, 0.4);
      border-radius: 60px;
      color: #FFE6B0;
      font-size: 0.9rem;
    ...
    .predict-trigger-btn:hover {
      background: linear-gradient(135deg, rgba(255, 180, 70, 0.25), rgba(255, 140, 26, 0.15));
      border-color: #ffb347;
      box-shadow: 0 0 30px rgba(255, 180, 70, 0.15);
      transform: scale(1.01);
    }
    .predict-trigger-btn:active {
    ...
    .predict-trigger-btn.live-blocked {
      opacity: 0.5;
      cursor: not-allowed;
      border-color: rgba(255, 68, 68, 0.3);
      background: rgba(255, 68, 68, 0.05);
    }
    .predict-trigger-btn.live-blocked:hover {
      transform: none;
      box-shadow: none;
    }
    ...
    .modal-content {
      background: linear-gradient(145deg, rgba(18, 38, 44, 0.95), rgba(10, 25, 30, 0.98));
      ...
      overflow-y: auto;
      border: 1px solid rgba(255, 180, 70, 0.3);
      box-shadow: 0 30px 80px rgba(0, 0, 0, 0.6), 0 0 40px rgba(255, 180, 70, 0.05);
      position: relative;
    }
    .modal-close {
      position: absolute;
    ...
    .modal-predict-options {
      display: flex;
      flex-direction: column;
      gap: 10px;
      margin-bottom: 16px;
    }
    .modal-predict-options label {
      display: flex;
      align-items: center;
      gap: 12px;
    ...
    .modal-predict-options label:hover {
      background: rgba(255, 255, 255, 0.06);
      border-color: rgba(255, 180, 70, 0.2);
    }
    .modal-predict-options input[type="radio"] {
      appearance: none;
      width: 20px;
      height: 20px;
    ...
    .modal-predict-options input[type="radio"]:checked {
      border-color: #ffb347;
      background: #ffb347;
    }
    .modal-predict-options input[type="radio"]:checked::after {
      content: '✓';
      position: absolute;
      top: 50%;
      left: 50%;
    ...
    .modal-predict-options .option-label {
      font-weight: 600;
      font-size: 0.9rem;
    }
    .modal-predict-options .option-sub {
      font-size: 0.7rem;
      color: #98bdc9;
    }
    ...
    .modal-user-input input:focus {
      border-color: #ffb347;
      background: rgba(255, 255, 255, 0.08);
      box-shadow: 0 0 20px rgba(255, 180, 70, 0.05);
    }
    .modal-user-input input::placeholder {
      color: #666;
    }
    ...
    .modal-submit-btn:hover {
      ...
      box-shadow: 0 0 30px rgba(255, 180, 70, 0.3);
    }
...
<div class="app-container">
  ...
  <!-- ===== ترتيب أصحاب التوقعات الصحيحة (في أول الصفحة) ===== -->
...
<script>
  ...
  function renderUpcoming() {
    try {
      ...
      // ربط أحداث الأزرار لفتح النافذة المنبثقة
  ...
  document.getElementById('modalSubmitBtn').addEventListener('click', async function() {
    ...
    const prediction = selectedOption.value;
